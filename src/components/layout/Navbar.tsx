      ...
      <div className="max-w-[1400px] mx-auto px-6 h-20 flex justify-between items-center">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-4 border-l border-black/10 dark:border-white/10 pl-4 ml-4">
            <ThemeToggle />
            <button className="px-5 py-2 rounded-full font-semibold text-sm bg-gradient-to-r from-primary to-purple-500 text-white hover:opacity-90 transition-opacity">
              Sign In
            </button>
          </div>
        </div>
